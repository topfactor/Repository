...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОрганизацииОтбора = ПланыОбмена._ДемоСинхронизацияДанныхЧерезУниверсальныйФормат.ОрганизацииОтбораИнтерактивнойВыгрузки(Параметры.Отбор);
...
Функция РезультатВыбора()
	...
	Результат.Вставить("ПредставлениеОтбора", 
		ПланыОбмена._ДемоСинхронизацияДанныхЧерезУниверсальныйФормат.ПредставлениеОтбораИнтерактивнойВыгрузки(УзелИнформационнойБазы, Результат));
