...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "ЗакрытаФормаПомощникаСозданияОбменаДанными"
		Или ИмяСобытия = "ЗакрытаФормаУдаленияНастройкиСинхронизации" Тогда
...
Процедура СписокПриложенийПриАктивизацииСтроки(Элемент)
	...
	Элементы.СписокПриложенийВыполнитьСинхронизациюСДополнительнымиОтборами.Доступность =
		ТекущиеДанные.ДоступнаИнтерактивнаяОтправка;
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ТекстЗапрещеннойЯчейкиЦвет);
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", "н/д");
...
Процедура ОткрытьПомощникИнтерактивнойСинхронизации(ДополнительныеПараметры)
	...
	ПараметрыПомощника.Вставить("ОтправитьДанные", 
		Не ДополнительныеПараметры.ВариантОбменаДанными = "ТолькоПолучение");
