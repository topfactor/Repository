...
Процедура ПолучитьАккаунтВызовОнлайнПоддержки(Команда)
	...
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку("http://buhphone.com/clients/be-client/");
...
Процедура ТехническиеТребования(Команда)
	...
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку("http://buhphone.com/require/#anchor_1");
...
Процедура СкачатьПриложение(Команда)
	...
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку("http://distribs.buhphone.com/current");
