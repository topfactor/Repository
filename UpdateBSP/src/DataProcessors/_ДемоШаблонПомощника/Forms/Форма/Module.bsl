...
Функция Подключаемый_СтраницаДва_ПриПереходеДалее(Отказ)
	...
	Если СУсловиямиОзнакомлен Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Выполняется обработчик ПриПереходеДалее страницы № 2'"));
	Иначе
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Необходимо сначала ознакомиться с условиями.'"),, "СУсловиямиОзнакомлен");
		Отказ = Истина;
	КонецЕсли;
...
Функция Подключаемый_СтраницаДва_ПриПереходеНазад(Отказ)
	...
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Выполняется обработчик ПриПереходеНазад страницы № 2'"));
...
Функция Подключаемый_СтраницаДва_ПриОткрытии(Отказ, ПропуститьСтраницу, Знач ЭтоПереходДалее)
	...
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Выполняется обработчик ПриОткрытии страницы № 2'"));
