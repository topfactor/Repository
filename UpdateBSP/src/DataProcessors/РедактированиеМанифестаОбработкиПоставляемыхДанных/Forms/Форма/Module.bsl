...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.РедактированиеМанифестаОбработкиПоставляемыхДанных.Форма.ВидДанных") Тогда
...
Процедура ВидыДанныхПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	ОткрытьФорму("Обработка.РедактированиеМанифестаОбработкиПоставляемыхДанных.Форма.ВидДанных", ПараметрыФормы, ЭтотОбъект);
