...
Процедура ПриНачалеУдаленияНастройкиСинхронизацииНаСервере(ПродолжитьОжидание)
	...
	Если ЭтоОбменСПриложениемВСервисе Тогда
		...
		МодульПомощникУдаленияНастройки = ОбщегоНазначения.ОбщийМодуль("Обработки.ПомощникНастройкиСинхронизацииДанныхМеждуПриложениямиВИнтернете");
	...
	Иначе
		...
		МодульПомощникУдаленияНастройки = ОбщегоНазначения.ОбщийМодуль("Обработки.ПомощникСозданияОбменаДанными");
...
Процедура УстановитьЗаголовкиЭлементовФормы()
	...
	Элементы.УдалитьНастройкуВКорреспонденте.Заголовок = СтрЗаменить(Элементы.УдалитьНастройкуВКорреспонденте.Заголовок,
...
Процедура ИнициализироватьРеквизитыФормы()
	...
	ЭтоОбменСПриложениемВСервисе = Параметры.ЭтоОбменСПриложениемВСервисе;
