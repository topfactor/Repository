...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаУстановитьПериодРассчитанныхИтогов", "Группировка", ГруппировкаПодчиненныхЭлементовФормы.Вертикальная);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаВключениеИтогов", "Группировка", ГруппировкаПодчиненныхЭлементовФормы.Вертикальная);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаПерестроениеИЗаполнениеАгрегатов", "Группировка", ГруппировкаПодчиненныхЭлементовФормы.Вертикальная);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаПолучениеОптимальныхАгрегатов", "Группировка", ГруппировкаПодчиненныхЭлементовФормы.Вертикальная);
		
		Элементы.ИтогиВключитьИспользованиеИтогов.ТолькоВоВсехДействиях = Истина;
		Элементы.ИтогиВыключитьИспользованиеИтогов.ТолькоВоВсехДействиях = Истина;
		Элементы.ВключитьИспользованиеТекущихИтогов.ТолькоВоВсехДействиях = Истина;
		Элементы.ВыключитьИспользованиеТекущихИтогов.ТолькоВоВсехДействиях = Истина;
		Элементы.ВключитьРазделениеИтогов.ТолькоВоВсехДействиях = Истина;
		Элементы.ВыключитьРазделениеИтогов.ТолькоВоВсехДействиях = Истина;
		Элементы.УстановитьПериодИтогов.ТолькоВоВсехДействиях = Истина;
		Элементы.ПересчитатьИтоги.ТолькоВоВсехДействиях = Истина;
		Элементы.ПересчитатьТекущиеИтоги.ТолькоВоВсехДействиях = Истина;
		Элементы.ПересчитатьИтогиЗаПериод.ТолькоВоВсехДействиях = Истина;
		Элементы.Найти.ТолькоВоВсехДействиях = Истина;
		Элементы.ОтменитьПоиск.ТолькоВоВсехДействиях = Истина;
		Элементы.ВыделитьВсе.ТолькоВоВсехДействиях = Истина;
