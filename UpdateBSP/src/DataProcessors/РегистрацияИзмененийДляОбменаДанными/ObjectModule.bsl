...
//    Поле - ПолеФормы - передается поле формы, содержащее номер принятого сообщения. 
//    Значение - Произвольный - используется в форме для вывода предупреждения при открытии формы.
//
// Возвращаемое значение:
