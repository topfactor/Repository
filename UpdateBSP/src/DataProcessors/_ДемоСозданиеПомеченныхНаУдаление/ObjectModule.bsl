...
Процедура СоздатьПомеченныеДляПрочихСценариев(Настройки, Результат)
	...
	Иначе
		...
		ДопРеквизит1Объект.НаборСвойств = Справочники.НаборыДополнительныхРеквизитовИСведений.Справочник__ДемоКонтрагенты;
	...
	Иначе
		...
		ЗаполнитьЗначенияСвойств(ДопРеквизит2Объект, ДопРеквизит1Объект, "ТипЗначения, Виден, ДополнительныеЗначенияИспользуются, Доступен, НаборСвойств");
	...
	ВидРасчета3Ссылка = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("ПланВидовРасчета._ДемоОсновныеНачисления.ОплатаКомандировки");
