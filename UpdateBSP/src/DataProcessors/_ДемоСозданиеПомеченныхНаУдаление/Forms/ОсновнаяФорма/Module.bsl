...
Процедура СоздатьОбъекты(Команда)
	...
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку("e1cib/navigationpoint/Администрирование/Обработка.УдалениеПомеченныхОбъектов.Команда.УдалениеПомеченныхОбъектов");
КонецПроцедуры
...
Процедура ЗапуститьРегламентноеЗадание(Команда)
	...
	ОбщегоНазначенияКлиент.ОткрытьНавигационнуюСсылку("e1cib/app/Обработка.ЖурналРегистрации");
КонецПроцедуры
