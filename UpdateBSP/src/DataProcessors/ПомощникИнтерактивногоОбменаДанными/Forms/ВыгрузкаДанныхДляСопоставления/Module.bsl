...
Процедура ПриОжиданииВыгрузкиДанныхДляСопоставления()
	...
	Если ПродолжитьОжидание Тогда
		ДлительныеОперацииКлиент.ОбновитьПараметрыОбработчикаОжидания(ПараметрыОбработчикаОжиданияВыгрузкиДанныхДляСопоставления);
...
Процедура ПриНачалеВыгрузкиДанныхДляСопоставленияНаСервере(ПродолжитьОжидание)
	...
	Иначе
		...
		МодульПомощникНастройки = ОбщегоНазначения.ОбщийМодуль("Обработки.ПомощникИнтерактивногоОбменаДанными");
	КонецЕсли;
	
	МодульПомощникНастройки.ПриНачалеВыгрузкиДанныхДляСопоставления(
...
Процедура ПриОжиданииВыгрузкиДанныхДляСопоставленияНаСервере(ПараметрыОбработчика, ПродолжитьОжидание)
	...
	МодульПомощникНастройки = ОбщегоНазначения.ОбщийМодуль(
		"Обработки.ПомощникИнтерактивногоОбменаДаннымиВМоделиСервиса");
	МодульПомощникНастройки.ПриОжиданииВыгрузкиДанныхДляСопоставления(ПараметрыОбработчика, ПродолжитьОжидание);
...
Процедура ПриЗавершенииВыгрузкиДанныхДляСопоставленияНаСервере()
	...
	МодульПомощникНастройки.ПриЗавершенииВыгрузкиДанныхДляСопоставления(
