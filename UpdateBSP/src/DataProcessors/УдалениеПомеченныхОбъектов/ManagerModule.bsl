...
Функция ЭтоТехническийОбъект(Знач ПолноеИмяОбъекта)
	Возврат ПолноеИмяОбъекта = "СПРАВОЧНИК.ИДЕНТИФИКАТОРЫОБЪЕКТОВМЕТАДАННЫХ"
		Или ПолноеИмяОбъекта = "СПРАВОЧНИК.ПРЕДОПРЕДЕЛЕННЫЕВАРИАНТЫОТЧЕТОВ"
		Или ПолноеИмяОбъекта = "СПРАВОЧНИК.ИДЕНТИФИКАТОРЫОБЪЕКТОВРАСШИРЕНИЙ"
		Или ПолноеИмяОбъекта = "СПРАВОЧНИК.ПРЕДОПРЕДЕЛЕННЫЕВАРИАНТЫОТЧЕТОВРАСШИРЕНИЙ";
КонецФункции
