...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.ГруппаПричины.ОтображатьЗаголовок = Истина;
		Элементы.ГруппаПричины.Заголовок = НСтр("ru = 'Места использования'");
		
		Для каждого ЭлементКоманднойПанели Из Элементы.СвязиНеУдаленныхКоманднаяПанель.ПодчиненныеЭлементы Цикл
			...
			ЭлементКоманднойПанели.ТолькоВоВсехДействиях = Ложь;
...
Процедура ВывестиОшибку(КраткоеПредставлениеОшибки, ПодробноеПредставлениеОшибки);
	Кратко = НСтр("ru = 'При удалении помеченных возникла ошибка:'") + Символы.ПС + КраткоеПредставлениеОшибки;
