...
// Параметры:
//  Ответственный              - СправочникСсылка.Пользователи - устанавливаемый ответственный.
//  МассивИзмененныхДокументов - Массив                        - массив документов взаимодействий, у которых изменился пользователь.
