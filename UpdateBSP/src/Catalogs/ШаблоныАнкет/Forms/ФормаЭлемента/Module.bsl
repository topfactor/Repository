...
Процедура ОткрытьФормуПростыхВопросов(ТекущиеДанные)
	...
	СтруктураПараметры.Вставить("ЭтоНоваяСтрока", ТекущиеДанные.ЭтоНоваяСтрока);
	СтруктураПараметры.Вставить("Подсказка", ТекущиеДанные.Подсказка);
	СтруктураПараметры.Вставить("СпособОтображенияПодсказки", ТекущиеДанные.СпособОтображенияПодсказки);
...
Процедура ОткрытьФормуМастераКомплексныхВопросов(ТекущиеДанные)
	...
	СтруктураПараметры = Новый Структура;
	СтруктураПараметры.Вставить("СоставКомплексногоВопроса",ТекущиеДанные.СоставКомплексногоВопроса);
	СтруктураПараметры.Вставить("Формулировка",ТекущиеДанные.Формулировка);
	СтруктураПараметры.Вставить("Подсказка",ТекущиеДанные.Подсказка);
	СтруктураПараметры.Вставить("СпособОтображенияПодсказки",ТекущиеДанные.СпособОтображенияПодсказки);
	СтруктураПараметры.Вставить("ЭтоНоваяСтрока",             ТекущиеДанные.ЭтоНоваяСтрока);
	
	ОткрытьФорму("Справочник.ШаблоныАнкет.Форма.ФормаМастераКомплексныхВопросов",СтруктураПараметры,ЭтотОбъект);
