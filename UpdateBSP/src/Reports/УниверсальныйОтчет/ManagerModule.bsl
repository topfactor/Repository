...
Функция ПараметрыОтчета(Настройки, ПользовательскиеНастройки) Экспорт
	...
	ПолучитьПараметрыИзПользовательскихНастроек(ПараметрыОтчета, ПользовательскиеНастройки);
...
//
Процедура ПолучитьПараметрыИзПользовательскихНастроек(Параметры, Настройки)
	Если ТипЗнч(Настройки) <> Тип("ПользовательскиеНастройкиКомпоновкиДанных")
		Или Настройки.Элементы.Количество() = 0 Тогда 
		Возврат;
	КонецЕсли;
