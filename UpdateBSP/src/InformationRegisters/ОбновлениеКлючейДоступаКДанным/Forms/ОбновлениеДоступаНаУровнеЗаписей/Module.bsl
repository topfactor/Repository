...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не УправлениеДоступомСлужебный.ОграничиватьДоступНаУровнеЗаписейУниверсально(Истина) Тогда
		...
		Элементы.ЗапуститьРегламентноеЗаданиеСейчас.Доступность = Ложь;
...
Процедура ОбновитьСостояниеЗаданияОбновленияДоступа(Состояние = Неопределено)
	...
	ВыполнениеЗаданияЗавершено = ЗначениеЗаполнено(ПоследнееЗавершениеРегламентногоЗадания)
		И ЗначениеЗаполнено(Состояние.ПоследнееЗавершениеРегламентногоЗадания)
		И ПоследнееЗавершениеРегламентногоЗадания <> Состояние.ПоследнееЗавершениеРегламентногоЗадания;
	...
	ПоследнееВыполнениеПродолжительность         = Состояние.ПоследнееВыполнениеПродолжительность;
	...
	Если Не Состояние.РегламентноеЗаданиеВыполняется Тогда
		Элементы.ВремяВыполненияРегламентногоЗадания1.Заголовок = "";
		Элементы.ВремяВыполненияРегламентногоЗадания2.Заголовок = "";
	...
	Элементы.ВремяВыполненияРегламентногоЗадания1.Заголовок = ТекстЗаголовка;
	Элементы.ВремяВыполненияРегламентногоЗадания2.Заголовок = ТекстЗаголовка;
	
	ВидимостьПервого = Элементы.ВремяВыполненияРегламентногоЗадания1.Видимость;
	ВидимостьПервого = Не ВидимостьПервого;
	
	Элементы.ВремяВыполненияРегламентногоЗадания1.Видимость =    ВидимостьПервого;
	Элементы.ВремяВыполненияРегламентногоЗадания2.Видимость = Не ВидимостьПервого;
...
Процедура ОтменитьИВыключитьОбновлениеДоступаНаСервере()
	...
	Отбор = Новый Структура("ИмяМетода", УправлениеДоступомСлужебный.ИмяМетодаОбновленияДоступаВФоне());
	ДополнительныеЗадания = ФоновыеЗадания.ПолучитьФоновыеЗадания(Отбор);
	
	Для Каждого ДополнительноеЗадание Из ДополнительныеЗадания Цикл
		Если ДополнительноеЗадание.Состояние = СостояниеФоновогоЗадания.Активно Тогда
			ДополнительноеЗадание.Отменить();
		КонецЕсли;
	КонецЦикла;
