...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.Переместить(Элементы.РеквизитыОбъектаВыбрать, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.ФормаУстановитьФлажки, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.ФормаСнятьФлажки, Элементы.ФормаКоманднаяПанель);
