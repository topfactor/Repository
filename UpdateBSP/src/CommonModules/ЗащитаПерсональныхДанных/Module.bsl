...
Функция ПриПодготовкеСпискаМакетовВФорматеОфисныхДокументовФормируемыхНаСервере(СписокМакетов) Экспорт
...
Функция ПрочитатьНастройкиСкрытияСубъектов(Знач Субъекты) Экспорт
	...
	Для Каждого Субъект Из Субъекты Цикл
		...
		НастройкиСкрытияСубъекта = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(НастройкиСкрытия);
...
Процедура РассчитатьДатуСкрытияПерсональныхДанныхПоОснованиям(Основания) Экспорт
