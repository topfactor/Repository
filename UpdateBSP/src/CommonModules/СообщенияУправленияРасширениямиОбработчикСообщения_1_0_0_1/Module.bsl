...
Процедура ОтключитьРасширение(Знач Сообщение, Знач Отправитель)
	...
	Если Сообщение.Body.Reason = "LockByOwner" Тогда
		...
		ПричинаОтключения = Перечисления.ПричиныОтключенияРасширенийВМоделиСервиса.БлокировкаВладельцем;
	...
	СообщенияУправленияРасширениямиРеализация.ОтключитьРасширение(Сообщение.Body.Extension, ПричинаОтключения);
