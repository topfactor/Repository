...
// Создает структуру выходной печатной формой.
...
Функция ИнициализироватьМакетОфисногоДокумента(ДвоичныеДанныеМакета, Знач УдалитьТипМакета, Знач УдалитьИмяМакета = "") Экспорт
	...
	Макет = УправлениеПечатьюСлужебный.ПолучитьМакет(ДвоичныеДанныеМакета);
	Если Макет <> Неопределено Тогда
...
// Подготовить таблицу значений, используемых при формировании печатных форм.
//
	...
	Для Каждого ОбъектМетаданных Из СписокОбъектов Цикл
		...
		Для Каждого ДобавляемаяКомандаПечати Из КомандыПечатиФормы Цикл
			...
			Для Каждого ИмеющаясяКомандаПечати Из КомандыПечати Цикл
				Если ИмеющаясяКомандаПечати.УникальныйИдентификатор = ДобавляемаяКомандаПечати.УникальныйИдентификатор Тогда
