...
Процедура ПриПоискеКонтактов(Знач ИмяТаблицыКонтактов, ТекстЗапросаДляПоиска) Экспорт
	...
	Если ИмяТаблицыКонтактов = Метаданные.Документы._ДемоЗаказПокупателя.ПолноеИмя() Тогда
		ТекстЗапросаДляПоиска = Документы._ДемоЗаказПокупателя.ТекстЗапросаПоКонтактам(Истина);
	КонецЕсли;
	// _Демо конец примера
