...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	РеквизитыДляПредставления = Новый Массив;
	РеквизитыДляПредставления.Добавить(Метаданные.Справочники._ДемоДоговорыКонтрагентов.СтандартныеРеквизиты.Наименование.Имя);
	РеквизитыДляПредставления.Добавить(Метаданные.Справочники._ДемоДоговорыКонтрагентов.Реквизиты.НомерДоговора.Имя);
	РеквизитыДляПредставления.Добавить(Метаданные.Справочники._ДемоДоговорыКонтрагентов.Реквизиты.ДатаДоговора.Имя);
	Настройки.РеквизитыДляПредставления.Вставить(Метаданные.Справочники._ДемоДоговорыКонтрагентов.ПолноеИмя(), 
		РеквизитыДляПредставления);
