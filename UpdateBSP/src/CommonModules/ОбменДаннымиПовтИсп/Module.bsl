...
Функция ЭтоУзелОбменаСообщениями(УзелИнформационнойБазы) Экспорт
	...
	Если Не ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаВМоделиСервиса.ОбменСообщениями") Тогда
		Возврат Ложь;
	КонецЕсли;
...
Функция НастройкиОбменаУзлаИнформационнойБазы(
	...
	Возврат ОбменДаннымиСервер.НастройкиОбменаДляУзлаИнформационнойБазы(
		УзелИнформационнойБазы,
		ДействиеПриОбмене,
		ВидТранспортаСообщенийОбмена,
...
Функция НастройкиОбменаДанными(НастройкаВыполненияОбмена, НомерСтроки) Экспорт
	...
	Возврат ОбменДаннымиСервер.НастройкиОбменаДанными(НастройкаВыполненияОбмена, НомерСтроки);
