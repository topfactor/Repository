...
//    * Кодировка                          - Строка - Кодировка, в которой сохранен файл. Список поддерживаемых  кодировок
//                                                    см. в справке к методу глобального контекста "ПолучитьДвоичныеДанныеИзСтроки".
//
...
Функция ДобавитьФайл(ПараметрыФайла,
	...
	Если ПараметрыФайла.Свойство("Кодировка")
		И Не ПустаяСтрока(ПараметрыФайла.Кодировка) Тогда
		
		РаботаСФайламиСлужебныйВызовСервера.ЗаписатьКодировкуВерсииФайла(ПрисоединенныйФайл.Ссылка, ПараметрыФайла.Кодировка);
...
Функция КодировкаФайла(ПрисоединенныйФайл, Расширение = "") Экспорт
	...
	Кодировка = РаботаСФайламиСлужебныйВызовСервера.ПолучитьКодировкуВерсииФайла(ПрисоединенныйФайл);
	Если Не ЗначениеЗаполнено(Кодировка) Тогда
		...
		Если ДвоичныеДанные <> Неопределено Тогда
			...
			Если Не ЗначениеЗаполнено(Кодировка)
				И СтрЗаканчиваетсяНа(НРег(Расширение), "xml") Тогда
