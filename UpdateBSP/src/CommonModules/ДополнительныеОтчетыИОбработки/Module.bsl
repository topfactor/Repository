...
Функция ПакетныйЗапускКонфигуратора(Параметры, КомандаЗапуска)
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(КомандаЗапуска, КомандаЗапуска);
	...
	РезультатЗапуска = ОбщегоНазначенияКлиентСервер.ЗапуститьПрограмму(КомандаЗапуска, ПараметрыЗапускаКоманды);
